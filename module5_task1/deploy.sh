...
scp -o StrictHostKeyChecking=accept-new -o ./awesome.tar.zip ubuntu@"$new_ec2_instance_public_ip":/home/ubuntu/

ssh -o StrictHostKeyChecking=accept-new -o ubuntu@"$new_ec2_instance_public_ip" "
